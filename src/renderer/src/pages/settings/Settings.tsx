...
function Settings() {
    ...
    const setNewDir = () => {
        ...
        window.api.getNewDir().then((res) => {

            // save the new config
            window.api.setConfig(JSON.stringify({ ...localConfig, outputDir: res[0] })).then((newConfig) => {
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <p><em>{settingsDir}</em></p>
                <Button className="primary-button" onClick={() => setNewDir()}>Change</Button>
            </div>
            <Modal show={showErrorModal} type={"error"}>
                <div>
                    ...
                    <div>
                        An error occurred while changing your settings.
                    </div>
